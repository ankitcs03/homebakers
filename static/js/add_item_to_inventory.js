document.addEventListener("DOMContentLoaded", function () {
  document
    .getElementById("addItemToInventoryForm")
          ...
          if (data.success) {
            ...
            if (existingRow) {
              ...
              newRow.insertCell(0).innerText =
                data.inventory_item.unique_item.name;
